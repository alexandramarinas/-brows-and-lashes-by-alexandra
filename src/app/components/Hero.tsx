...
export default function Hero() {
  return <section id="acasa" className="relative isolate overflow-hidden bg-white">
    <Image src="/images/frunza.jpeg" alt="" fill priority sizes="100vw" className="-z-20 object-cover object-right opacity-[0.58]" />
